...
def build_top_1_comments():
    ...
    with open('comments_top1.tsv', 'w', encoding='utf8') as fw:
...
def build_multi_choice_top1():
    with open('comments_top1_multi_choice.tsv', 'w', encoding='utf8') as fw:
        with open('comments_top1.tsv', 'r', encoding='utf8') as fr:
            lines = fr.readlines()
            lines = [line[:-1] for line in lines]
            for line in lines:
                ss = line.split('\t')
...
if __name__ == '__main__':
    ...
    # merge_dataset(['AskMen', 'AskWomen'])
    # build_top_1_comments()
    # split_dataset('comments_top1')

    # build_multi_choice_top1()
    # split_dataset('comments_top1_multi_choice')
